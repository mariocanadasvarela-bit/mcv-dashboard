// app.js - MCV Seguros Dashboard - Versión final con mejoras de legibilidad y funcionalidad
...
let currentEmpresa = 'GHM SRL';   // 'GHM SRL', 'GHM Satelital SRL' o 'Ambas'
...
// (Aquí van todas las correcciones que ya teníamos, desde 68280884 hasta 1233958)
// Por brevedad no repito todo el bloque, pero es el mismo que en la versión anterior.
// Asegúrate de incluirlo completo. Usaré el mismo código que ya funcionaba.

// ... (incluir todas las correcciones previas) ...
...
function renderChart(canvasId, chartKey, dataObj, label) {
    ...
    if (chartTypes[chartKey] === 'pie') {
        ...
        charts[chartKey] = new Chart(ctx, { type: 'bar', data: { labels, datasets: [{ label, data: values, backgroundColor: '#a5f3fc', borderRadius: 8 }] }, options: { indexAxis: 'y', responsive: true, maintainAspectRatio: true } }); // onClick eliminado
    }
}
